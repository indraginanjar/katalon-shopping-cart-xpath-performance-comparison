...
for (def index : (0..GlobalVariable.loops)) {
    WebUI.waitForElementClickable(findTestObject('Page_Katalon Shop  Katalon Ecommerce/a_Katalon Shop'), 30)
    ...
    WebUI.waitForElementClickable(findTestObject('Page_Katalon Shop  Katalon Ecommerce/a_Cart'), 30)
    ...
    WebUI.waitForElementClickable(findTestObject('Page_Katalon Shop  Katalon Ecommerce/a_Checkout'), 30)
    ...
    WebUI.waitForElementClickable(findTestObject('Page_Katalon Shop  Katalon Ecommerce/a_My account'), 30)
    ...
    WebUI.waitForElementClickable(findTestObject('Page_Katalon Shop  Katalon Ecommerce/a_Sample Page'), 30)
    ...
    WebUI.waitForElementClickable(findTestObject('Page_Katalon Shop  Katalon Ecommerce/a_Shop'), 30)
