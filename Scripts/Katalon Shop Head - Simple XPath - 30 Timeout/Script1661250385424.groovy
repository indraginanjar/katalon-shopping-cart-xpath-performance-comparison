...
for (def index : (0..GlobalVariable.loops)) {
    ...
    WebUI.waitForElementClickable(findTestObject('Page_Katalon Shop  Katalon Ecommerce/a_Cart - Simple XPath'), 30)
    ...
    WebUI.waitForElementClickable(findTestObject('Page_Katalon Shop  Katalon Ecommerce/a_Checkout - Simple XPath'), 30)
    ...
    WebUI.waitForElementClickable(findTestObject('Page_Katalon Shop  Katalon Ecommerce/a_My account - Simple XPath'), 30)
    ...
    WebUI.waitForElementClickable(findTestObject('Page_Katalon Shop  Katalon Ecommerce/a_Sample Page - Simple XPath'), 30)
    ...
    WebUI.waitForElementClickable(findTestObject('Page_Katalon Shop  Katalon Ecommerce/a_Shop - Simple XPath'), 30)
