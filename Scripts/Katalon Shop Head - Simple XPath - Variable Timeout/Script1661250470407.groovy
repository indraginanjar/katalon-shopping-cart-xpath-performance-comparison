...
for (def index : (0..GlobalVariable.loops)) {
    ...
    WebUI.waitForElementClickable(findTestObject('Page_Katalon Shop  Katalon Ecommerce/a_Cart - Simple XPath'), GlobalVariable.timeout)
    ...
    WebUI.waitForElementClickable(findTestObject('Page_Katalon Shop  Katalon Ecommerce/a_Checkout - Simple XPath'), GlobalVariable.timeout)
    ...
    WebUI.waitForElementClickable(findTestObject('Page_Katalon Shop  Katalon Ecommerce/a_My account - Simple XPath'), GlobalVariable.timeout)
    ...
    WebUI.waitForElementClickable(findTestObject('Page_Katalon Shop  Katalon Ecommerce/a_Sample Page - Simple XPath'), GlobalVariable.timeout)
    ...
    WebUI.waitForElementClickable(findTestObject('Page_Katalon Shop  Katalon Ecommerce/a_Shop - Simple XPath'), GlobalVariable.timeout)
